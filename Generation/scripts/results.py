...
argParser.add_argument('--model',       action='store',         default='HEL_UFO',  choices=['SMEFTatNLO', 'ewkDM', 'HEL_UFO', 'TopEffTh', 'ewkDMGZ', 'dim6top_LO', 'dim6top_LO_v2'], help="Which madgraph model?")
