...
argParser.add_argument('--model',       action='store',         default='HEL_UFO',  choices=['SMEFTatNLO', 'ewkDM', 'ewkDM2', 'ewkDMGZ', 'HEL_UFO', 'TopEffTh', 'dim6top_LO', 'dim6top_LO_v2'], help="Which madgraph model?")
