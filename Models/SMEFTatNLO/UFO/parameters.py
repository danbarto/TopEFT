...
cpQ3 = Parameter(name = 'cpQ3',
                 ...
                 type = 'real',
                 value = 1,
                 texname = '\\text{Subsuperscript}[c,\\text{$\\phi $Q},\\text{(1)}]',
                 lhablock = 'DIM62F',
                 lhacode = [ 12 ])
...
cQe = Parameter(name = 'cQe',
                ...
                type = 'real',
                value = 'cQe1',
                texname = '\\text{Subsuperscript}[c,\\text{Qe},\\text{[int]}]')

cQmu = Parameter(name = 'cQmu',
                 nature = 'internal',
                 type = 'real',
                 value = 'cQe2',
                 texname = '\\text{Subsuperscript}[c,\\text{Q$\\mu $},\\text{[int]}]')

cQq11Internal = Parameter(name = 'cQq11Internal',
                          nature = 'internal',
                          type = 'real',
                          value = 'cQq11/2.',
                          texname = '\\text{Subsuperscript}[c,\\text{Qq},\\text{(1,1)[int]}]')

cQq13Internal = Parameter(name = 'cQq13Internal',
                          nature = 'internal',
                          type = 'real',
                          value = 'cQq13/2.',
                          texname = '\\text{Subsuperscript}[c,\\text{Qq},\\text{(1,3)[int]}]')

cQq81Internal = Parameter(name = 'cQq81Internal',
                          nature = 'internal',
                          type = 'real',
                          value = 'cQq81/2.',
                          texname = '\\text{Subsuperscript}[c,\\text{Qq},\\text{(8,1)[int]}]')

cQq83Internal = Parameter(name = 'cQq83Internal',
                          nature = 'internal',
                          type = 'real',
                          value = 'cQq83/2.',
                          texname = '\\text{Subsuperscript}[c,\\text{Qq},\\text{(8,3)[int]}]')

cQta = Parameter(name = 'cQta',
                 nature = 'internal',
                 type = 'real',
                 value = 'cQe3',
                 texname = '\\text{Subsuperscript}[c,\\text{Q$\\tau $},\\text{[int]}]')

cte = Parameter(name = 'cte',
                nature = 'internal',
                type = 'real',
                value = 'cte1',
                texname = '\\text{Subsuperscript}[c,\\text{te},\\text{[int]}]')

ctmu = Parameter(name = 'ctmu',
                 nature = 'internal',
                 type = 'real',
                 value = 'cte2',
                 texname = '\\text{Subsuperscript}[c,\\text{t$\\mu $},\\text{[int]}]')

ctta = Parameter(name = 'ctta',
                 nature = 'internal',
                 type = 'real',
                 value = 'cte3',
                 texname = '\\text{Subsuperscript}[c,\\text{t$\\tau $},\\text{[int]}]')

ctu1Internal = Parameter(name = 'ctu1Internal',
                         nature = 'internal',
                         type = 'real',
                         value = 'ctu1/2.',
                         texname = '\\text{Subsuperscript}[c,\\text{tu},\\text{(1)[int]}]')

ctu8Internal = Parameter(name = 'ctu8Internal',
                         nature = 'internal',
                         type = 'real',
                         value = 'ctu8/2.',
                         texname = '\\text{Subsuperscript}[c,\\text{tu},\\text{(8)[int]}]')
...
c3pQ3Internal = Parameter(name = 'c3pQ3Internal',
                          nature = 'internal',
                          type = 'real',
                          value = 'cpQ3',
                          texname = '\\text{Subsuperscript}[c,\\text{$\\phi $Q},\\text{(3)[int]}]')

c3pqiInternal = Parameter(name = 'c3pqiInternal',
                          nature = 'internal',
                          type = 'real',
                          value = 'cpq3i',
                          texname = '\\text{Subsuperscript}[c,\\text{$\\phi $q},\\text{(3)[int]}]')
...
cpQ3Internal = Parameter(name = 'cpQ3Internal',
                         nature = 'internal',
                         type = 'real',
                         value = 'cpQ3 + cpQM',
                         texname = '\\text{Subsuperscript}[c,\\text{$\\phi $Q},\\text{(1)[int]}]')

cpqiInternal = Parameter(name = 'cpqiInternal',
                         nature = 'internal',
                         type = 'real',
                         value = 'cpq3i + cpqMi',
                         texname = '\\text{Subsuperscript}[c,\\text{$\\phi $q},\\text{(1)[int]}]')
